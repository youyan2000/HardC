...
//
// 仅 BSP 后端 (bsp_hrtim.c / bsp_delay.c / bsp_adc_stm32.c / bsp_gpio_stm32.c / bsp_uart_stm32.c) include 本文件.
// Devices/comm 传输层已改为经 BSP 不透明句柄 (bsp_uart.h 等), 不再 include 本文件 (BSP 之上零 HAL).
