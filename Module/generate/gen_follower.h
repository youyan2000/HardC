...
#ifndef GEN_FOLLOWER_H
#define GEN_FOLLOWER_H
...
#include "gen_motor.h"  // MotApp   (完整定义头)
#include "gen_turn.h"   // TurnCtrl (完整定义头)
...
void follower_init(Follower *me, MotApp *mtr_a, MotApp *mtr_b, AdcBase *adc, PidBase *pid_p2pd, TurnCtrl *turn);
