...
typedef enum {
  PMB_CMD_PAGE = 0x00,
  PMB_CMD_OPERATION = 0x01,
  PMB_CMD_ON_OFF_CONFIG = 0x02,
  PMB_CMD_CLEAR_FAULTS = 0x03,
  PMB_CMD_WRITE_PROTECT = 0x10,
  PMB_CMD_VOUT_MODE = 0x20,
  PMB_CMD_VOUT_COMMAND = 0x21,
  PMB_CMD_VOUT_MAX = 0x24,
  PMB_CMD_VOUT_TRANSITION = 0x27,
  PMB_CMD_VOUT_DROOP = 0x28,
  PMB_CMD_VOUT_SCALE_LOOP = 0x29,
  PMB_CMD_VOUT_SCALE_MONITOR = 0x2A,
  PMB_CMD_IOUT_CAL_GAIN = 0x38,
  PMB_CMD_FREQUENCY_SWITCH = 0x33,
  PMB_CMD_POWER_MODE = 0x3A,
  PMB_CMD_STATUS_BYTE = 0x78,
  PMB_CMD_STATUS_WORD = 0x79,
  PMB_CMD_STATUS_VOUT = 0x7A,
  PMB_CMD_STATUS_IOUT = 0x7B,
  PMB_CMD_STATUS_INPUT = 0x7C,
  PMB_CMD_STATUS_TEMP = 0x7D,
  PMB_CMD_STATUS_CML = 0x7E,
  PMB_CMD_READ_VIN = 0x88,
  PMB_CMD_READ_VOUT = 0x8B,
  PMB_CMD_READ_IOUT = 0x8C,
  PMB_CMD_READ_TEMP_1 = 0x8D,
  PMB_CMD_READ_TEMP_2 = 0x8E,
  PMB_CMD_READ_DUTY = 0x94,
  PMB_CMD_READ_FREQ = 0x95,
  PMB_CMD_READ_POUT = 0x96,
  PMB_CMD_READ_PIN = 0x97,
  PMB_CMD_MFR_ID = 0x99,
  PMB_CMD_MFR_MODEL = 0x9A,
  PMB_CMD_MFR_REVISION = 0x9B,
  PMB_CMD_MFR_SPECIFIC_BASE = 0xD0,  // 0xD0~0xFF 制造商自定义
  PMB_CMD_COUNT
} PmbusCmd;
