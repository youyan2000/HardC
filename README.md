...
| COM | `comp_comm` | `com_uart`, `com_spi`, `com_i2c`, `com_can`, `com_key`, `com_mpu6050`, `com_oled`, `com_ultrasonic` | `mod_comm`, `mod_cmd_dispatch`, `mod_serial_proto` |
| GPO | `comp_gpo` | `gpo_led`, `gpo_laser`, `gpo_beep`, `gpo_buzzer`, `gpo_fan` | — |
| PID | `comp_pid` | `pid_standard`, `pid_cascade`, `pid_p2pd`, `pid_parallel`, `pid_pr`, `pid_qpr` | — |
| PWM | `comp_pwm` | `pwm_buckboost`, `pwm_half_bridge`, `pwm_full_bridge`, `pwm_interleaved`, `pwm_resonant` | `mod_powerctrl` |
| Motor | `comp_motor` | `motor_tim` | — |
...
| [LESSONS.md](LESSONS.md) | 34 条调参教训 |
